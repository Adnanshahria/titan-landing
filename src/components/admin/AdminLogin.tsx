  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="font-heading text-2xl font-bold text-primary-foreground uppercase text-center mb-6">{t("admin.adminAccess")}</h1>
        ...
        {error && <p className="text-destructive text-xs mt-2 text-center">{t("admin.incorrectPassword")}</p>}
        <button
          type="submit"
